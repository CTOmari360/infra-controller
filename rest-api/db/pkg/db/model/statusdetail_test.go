...
func TestStatusDetailSQLDAO_GetAllByEntityID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, total, err := sdDAO.GetAllByEntityID(tt.args.ctx, nil, tt.args.entityid, tt.args.page)
			if tt.wantErr {
				assert.NotNil(t, err)
			} else {
...
func TestStatusDetailSQLDAO_GetAllByEntityIDs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, total, err := sdDAO.GetAllByEntityIDs(tt.args.ctx, nil, tt.args.entityids, tt.args.page)
			if tt.wantErr {
				assert.NotNil(t, err)
			} else {
				assert.Equal(t, tt.wantCount, len(got))
